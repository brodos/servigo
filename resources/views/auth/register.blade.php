...
<div class="mx-3 sm:mx-auto sm:max-w-sm mb-4 sm:mb-10">
    <div class="card rounded bg-white shadow-lg">
        ...
        <div class="card-header p-6 lg:p-8 border-b lg:border-grey-lighter flex items-center justify-center">
            ...
            <span class="font-bold text-lg leading-normal text-indigo-dark uppercase">Crează un cont nou</span>
        ...
        <div class="card-body p-6 lg:p-8">
            <form method="POST" action="{{ route('register') }}" class="m-0">
                ...
                <div>
                    ...
                    <label class="block font-bold text-sm text-indigo-darker mb-2" for="name">Nume afișat</label>
                ...
                <div class="mt-6">
                    ...
                    <label class="block font-bold text-sm text-indigo-darker mb-2" for="phone">Telefon</label>

                    <input type="phone" id="phone" name="phone" class="font-bold w-full focus:outline-none appearance-none p-4 bg-grey-lighter rounded leading-tight text-grey-darkest" value="{{ old('phone') }}" required placeholder="+407xxxxxxxx">

                    @if ($errors->has('phone'))
                        <p class="has-error text-sm mt-1 text-red-dark">{{ $errors->first('phonr') }}</p>
                    @endif
                ...
                <div class="mt-6">
                    <label class="block flex items-center">
                        ...
                        <span class="text-sm text-grey-darker leading-normal cursor-pointer">
                            Sunt de acord cu <a href="#terms" class="text-blue-dark hover:text-blue-darker">termenii și condițiile</a> de utilizare și cu <a href="#privacy" class="text-blue-dark hover:text-blue-darker">politica de confidențialitate</a> a platformei Servigo.
                        </span>
                    </label>
                ...
                <div class="mt-6 text-center">
                    <button type="submit" class="w-full btn btn-indigo">Crează cont</button>
                </div>
        ...
        <div class="card-footer bg-grey-lightest p-8 border-t border-grey-lighter flex items-center justify-center text-sm"> 
            ...
            <a href="{{ route('login') }}" class="font-bold text-indigo-dark no-underline hover:text-indigo-darker">Ai deja un cont?</a>
