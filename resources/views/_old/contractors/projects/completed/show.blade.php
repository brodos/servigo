...
@section('right-sidebar')
    <div class="col-3 sticky">
        ...
        <div class="top-sidebar pb-5">
            ...
            <a href="{{ route('contractor-search-projects.show') }}">Cauta proiecte noi</a>
        ...
        <ul  class="list-unstyled">
            ...
            <li class="py-2">
                ...
                Calificativ acordat: {{ $project->feedback->where('from_user_id', auth()->user()->id)->first()->rating ?? '--' }}
                
            </li>

            <li class="py-2">
                Calificativ primit: {{ $project->feedback->where('to_user_id', auth()->user()->id)->first()->rating ?? '--' }}
            </li>
