...
<div class="shadow bg-white rounded mb-5">
	...
	<div class="d-flex p-4 border-bottom bg-light justify-content-between">
		<h2 class="flex-fill w-100">Proiecte finalizate</h2>
    ...
    @if ($projects->isEmpty())
		<div class="justify-content-center text-center ">
			<div class="p-5 lead">Nu exista proiecte finalizate.</div>
		</div>
	@else
			...
			<div class="border-bottom d-flex flex-column align-items-between">
				<div class="top p-3 d-flex justify-content-between">
					<div class="left flex-grow-1">
						<a href="{{ route('contractor-completed-projects.show', $project->id) }}"><span class="lead">{{ $project->name }}</span></a>
					</div>
					<div class="right">
						<a href="#">
