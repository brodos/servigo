<div class="w-1/3 md:w-auto text-sm text-grey hover:text-green inline-flex items-center justify-center leading-none lg:ml-6" title="Oferte primite">
	...
	<span class="font-bold text-base tracking-tight">{{ $slot }}</span>
</div>